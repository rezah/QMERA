...
x=R[:,0]
y=R[:,1]
y= [   abs ( ((i/(16.*16.))+0.643528)/0.643528 )            for i in y]
...
xt=R[:,0]
yt=R[:,1]
yt= [   abs ( ((i/(16.*16.))+0.643528)/0.643528 )            for i in yt]
...
plt.axhline(   abs( (0.62905-0.643528)/0.643528) ,color='#204a87', label='PEPS, D=4')
plt.axhline(   0.00007 ,color='#204a87', label='PEPS, D=8')
