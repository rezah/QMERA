...
y=R[:,1]
y=list(y)
errord= [ abs  ( (i+672.0819)/672.0819)   for i in y]
...
y=R[:,1]
y=list(y)
errors= [ abs  ( (i+672.0819)/672.0819)   for i in y]
...
y=R[:,1]
y=list(y)
errorp= [ abs  ( (i+672.0819)/672.0819)   for i in y]
...
y=R[:,1]
y=list(y)
errorm= [ abs  ( (i+672.0819)/672.0819)   for i in y]
...
yf=R[:,1]
yf=list(yf)
errorf= [ abs  ( (i+672.0819)/672.0819)   for i in yf]
...
# plt.plot( x_memoryd,errord,'D-',markersize=10, color = '#0e9c38', label='fMERA')
# plt.plot(x_memoryf,errorf,'s-',markersize=10, color = '#cf729d', label='ffMERA')
...
plt.plot( x_flopsd,errord,'D-',markersize=10, color = '#0e9c38', label='fMERA')
plt.plot(x_flopsf,errorf,'s-',markersize=10, color = '#cf729d', label='ffMERA')
...
plt.axhline(0.028,ls="--",color='black', label='PEPS, D=2')
plt.axhline(0.015,ls="--",color='black', label='PEPS, D=3')
plt.axhline(0.010,ls="--",color='black', label='PEPS, D=4')
