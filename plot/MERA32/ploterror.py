...
x=R[:,0]
y=R[:,1]
y= [   abs ( ((i/(32.*32.))+0.65633)/0.65633 )            for i in y]
...
#xt=R[:,0]
#yt=R[:,1]
#yt= [   abs ( ((i/(32.*32.))+0.65633)/0.65633 )            for i in yt]
...
plt.axhline(   abs( (0.62505-0.65633)/0.65633) ,color='#204a87', label='PEPS, D=4')
plt.axhline(   0.00014 ,color='#204a87', label='PEPS, D=8')
