...
x=R[:,0]
y=R[:,1]
y= [   abs ( ((i/(12.*12.))+0.635203)/0.635203 )            for i in y]
...
xt=R[:,0]
yt=R[:,1]
yt= [   abs ( ((i/(12.*12.))+0.635203)/0.635203 )            for i in yt]
...
plt.axhline(   abs( (0.6299-0.635203)/0.635203) ,color='#204a87', label='PEPS, D=4')
plt.axhline(   0.00009 ,color='#204a87', label='PEPS, D=8')
